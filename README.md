...
4. After your walk, choose **I walked this**. Completed walks stay in IndexedDB on this device, including the route itself. In **Your walks**, click a name to rename it, **Show on map** to bring the route back (it can be edited, reversed, and exported again), or **Remove** to delete it.
